                  ...
                  <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
						...
						<td>
                          <img style="border-radius:50%;" width="60px" src="../assets/images/ProductImage/category/<?php echo htmlentities($result->cateimg);?>" />
                        </td>
                        <td>
                          <?php echo htmlentities($result->categry);?>
                        </td>
                        <td>
                          <a href="manage-category.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');">
